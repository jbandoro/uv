...
fn lock_transitive_git() -> Result<()> {
    ...
    insta::with_settings!({
        ...
        name = "flask"
        version = "3.0.3"
        source = { url = "https://aws@files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl" }
        dependencies = [
            { name = "blinker" },
            { name = "click" },
        ...
        wheels = [
            { url = "https://aws@files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl", hash = "sha256:34e815dfaa43340d1d15a5c3a02b8476004037eb4840b34910c6e21679d288f3" },
        ]

        [package.metadata]
        requires-dist = [
            { name = "asgiref", marker = "extra == 'async'", specifier = ">=3.2" },
            { name = "blinker", specifier = ">=1.6.2" },
            { name = "click", specifier = ">=8.1.3" },
            { name = "importlib-metadata", marker = "python_full_version < '3.10'", specifier = ">=3.6.0" },
        ...
        [package.metadata]
        requires-dist = [{ name = "flask", url = "https://aws@files.pythonhosted.org/packages/61/80/ffe1da13ad9300f87c93af113edd0638c75138c42a0994becfacac078c06/flask-3.0.3-py3-none-any.whl" }]
