...
fn sync_all() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.sync().arg("--all"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sync_all_extras() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.sync().arg("--all").arg("--extra").arg("types"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    uv_snapshot!(context.filters(), context.sync().arg("--all").arg("--extra").arg("testing"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    // Sync all extras.
    uv_snapshot!(context.filters(), context.sync().arg("--all").arg("--all-extras"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
...
fn sync_all_groups() -> Result<()> {
    ...
    uv_snapshot!(context.filters(), context.sync().arg("--all").arg("--group").arg("types"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    uv_snapshot!(context.filters(), context.sync().arg("--all").arg("--group").arg("testing"), @r###"
    success: true
    exit_code: 0
    ----- stdout -----
    ...
    uv_snapshot!(context.filters(), context.sync().arg("--all").arg("--group").arg("foo"), @r###"
    success: false
    exit_code: 2
    ----- stdout -----
